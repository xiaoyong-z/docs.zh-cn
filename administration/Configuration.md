...
|max_compaction_concurrency|4|BaseCompaction + CumulativeCompaction 的最大并发，默认值是4, -1 就是没有限制|
|compaction_trace_threshold|60|单次Compaction打印trace的时间阈值，默认如果单次compaction超过60s就打印trace|
